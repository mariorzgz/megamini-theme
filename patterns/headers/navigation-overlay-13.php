...
/**
 * Title: Center 03
 * Slug: twentigone/navigation-overlay-13
 * Categories: header
...
<div class="wp-block-group has-base-background-color has-background" style="min-height:100vh;padding-right:var(--wp--preset--spacing--site-padding);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--site-padding)">
	...
	<!-- /wp:group -->
	<!-- wp:navigation {"showSubmenuIcon":false,"submenuVisibility":"always","overlayMenu":"never","style":{"spacing":{"blockGap":"var:preset|spacing|15"},"layout":{"selfStretch":"fit","flexSize":null},"typography":{"lineHeight":"1.2"}},"fontSize":"xx-large","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"},"twHoverStyle":"none"} -->
	...
	<div class="wp-block-group">
		<!-- wp:social-links {"className":"is-style-logos-only header-social","twHover":"none"} -->
		<ul class="wp-block-social-links is-style-logos-only header-social tw-hover-none">
